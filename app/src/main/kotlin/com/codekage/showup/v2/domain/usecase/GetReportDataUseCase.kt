...
class GetReportDataUseCase(
    ...
    private fun buildWeeklyStats(
        startDate: LocalDate,
        endDate: LocalDate,
        recordsByDate: Map<LocalDate, com.codekage.showup.v2.domain.model.AttendanceRecord>,
        nonWorkDayByDate: Map<LocalDate, com.codekage.showup.v2.domain.model.NonWorkDay>,
